USE [vetversedb]
GO
/****** Object:  Table [dbo].[Clients]    Script Date: 23/08/2022 5:20:34 pm ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[EntityStatus]    Script Date: 23/08/2022 5:20:34 pm ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Gender]    Script Date: 23/08/2022 5:20:34 pm ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[migrations]    Script Date: 23/08/2022 5:20:34 pm ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[PetCategory]    Script Date: 23/08/2022 5:20:34 pm ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[PetType]    Script Date: 23/08/2022 5:20:34 pm ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Roles]    Script Date: 23/08/2022 5:20:34 pm ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Staff]    Script Date: 23/08/2022 5:20:34 pm ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Users]    Script Date: 23/08/2022 5:20:34 pm ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[UserType]    Script Date: 23/08/2022 5:20:34 pm ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[Roles] ([RoleId], [Name], [Access]) VALUES (1, N'Admin', N'Appointments,Health Records,Users,Roles')
GO
INSERT [dbo].[Roles] ([RoleId], [Name], [Access]) VALUES (2, N'Manager', NULL)
GO
INSERT [dbo].[Roles] ([RoleId], [Name], [Access]) VALUES (3, N'Veterinarian', NULL)
GO
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [U_Roles]    Script Date: 23/08/2022 5:20:34 pm ******/
...
GO
/****** Object:  StoredProcedure [dbo].[usp_Reset]    Script Date: 23/08/2022 5:20:34 pm ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
